      ...
      <li class="nav-item">
        ...
        <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            <h6 class="collapse-header">Pilihan Pakaian:</h6>
...
<!--       <li class="nav-item">
        ...
        <div id="collapseUtilities" class="collapse" aria-labelledby="headingUtilities" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            <h6 class="collapse-header">Custom Other:</h6>
            <a class="collapse-item" href="utilities-border.html">Profile</a>
            <a class="collapse-item" href="utilities-animation.html">Lupa Password</a>
            <a class="collapse-item" href="<?php echo base_url('registrasi/index'); ?>">Registrasi</a>
          </div>
        </div>
      </li> -->
      <!-- Divider -->
      ...
      <li class="nav-item ">
        <a class="nav-link" href="<?php echo base_url('registrasi/index') ?>">
          ...
          <ul class="navbar-nav ml-auto">
            ...
            <div class="navbar">
              <ul class="nav navbar-nav navbar-right">
                <li>
                  <?php 
                  $keranjang = '<i class="fas fa-shopping-cart"></i> Total: '.$this->cart->total_items(). ' items' 
                  ?>
              ...
              <div class="topbar-divider d-none d-sm-block"></div>
                ...
                <ul class="nav navbar-nav navbar-right">
                  <?php if($this->session->userdata('username')) { ?>
                    ...
                    <div class="topbar-divider d-none d-sm-block"></div>
                    <li class="mt-2"><?php echo anchor('auth/logout', '<i class="fas fa-sign-in-alt"></i> Logout') ?></li>
                  <?php } else { ?>
                    <li><?php echo anchor('auth/login', '<i class="fas fa-sign-in-alt"></i> Login'); ?></li>
                  <?php } ?>
                </ul>
              </div>
